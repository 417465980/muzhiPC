...
<style scoped>
	...
	.news_info .active_tit .hot_icon i{ width: 24px; height: 28px;display:inline-block;background-position: -117px -54px;margin-right: 10px; vertical-align: middle;}
	.news_info .new_content{border-top:1px solid #e9e9e9;margin-top: 10px;}
	.news_info .new_content h2{ background: linear-gradient(to right, #716da8, #d0296e);
	-webkit-background-clip: text; color: transparent;line-height: 65px;cursor: pointer;    color: #d0296e\0;background:none\0;}
	...
	.news_info .new_content li a{flex: 0 0 43; margin-right: 10px; height: 20px;width: 43px;border: 1px solid #cf387f;text-align: center;line-height: 20px;
		color:#cf387f;font-size:12px;border-radius: 5px;display: inline-block\0;
	}
