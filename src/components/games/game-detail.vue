                        ...
                        <div class="game-name">
                            <div class="fl game-column-left">
                                ...
                                <div class="game-name-box">
                                    {{rows.website}}
                                    <h4><span>{{rows.name}}</span><a v-show="rows.website" :href="rows.website">官网</a></h4>
                                    <p>版本：1.0.0.0</p>
                                    <p>类型：{{rows.type}}</p>
                            ...
                            <div class="game-column-right listTitle fr">
                                <a class="getLb game-active" href="javascript:;" @click="markfqa(rows.downloadLink)"><i class="gmCen_spri"></i> <span>礼包领取</span></a><br>
