			...
			<div class="content">
				<ul class="clearfix">
					...
					<li class="count fr" v-else>
						<span class="middlespan" ></span>
						<router-link  to="/user" tag="span" v-html="checkUser"></router-link>&nbsp;&nbsp;|&nbsp;&nbsp;<span @click="signOut">退出</span>
...
<style scoped>
	...
	.head{width: 100%;height: 40px;background: url('../assets/images/head_bg.png') no-repeat center center;background-size:100% 100%;}
	.head .content,.nav{width: 1200px;margin: 0 auto;}
	.head ul li{height: 40px;/* display: flex;align-items: center; */ color:#fff;}
	.head ul li a{color: #fff;font-size: 0; display: inline-block; height: 100%;}
	.head ul li a span{    
		vertical-align: middle;
		font-size: 13px;
	}
	.head li.mobile{margin-left: 10px;}
	.head li.muzhi i{width: 19px; height: 15px;background-position: -48px -112px;display: inline-block; vertical-align: middle;}
	...
	.head li.mobile i{width: 11px; height: 21px;display: inline-block; background-position: -168px -82px;margin-right:5px; vertical-align: middle;}
	.head li.count i{width: 18px; height: 18px;background-position: -10px -112px;display: inline-block;margin-right: 5px;vertical-align: middle; }
	.count span {cursor: pointer;color:#fff; font-size:13px; vertical-align: middle;}
	...
	.nav .search{font-size: 0; display: flex;align-items: center;justify-content: center; height:100%; position: relative;display: block\0;}
	.nav input,.nav .search .searchBtn{width: 45px;}
	.nav .search input{height: 30px; font-size: 12px; width: 165px; border-radius:15px 0 0 15px;border: 1px solid #dadada; color: #a9a9a9;padding-left: 20px; vertical-align: middle;}
	.nav .search .searchBtn{height: 32px;border-radius:0 15px 15px 0;background-color: #bb3679;display: inline-block;position: relative;cursor: pointer;vertical-align: middle;}
